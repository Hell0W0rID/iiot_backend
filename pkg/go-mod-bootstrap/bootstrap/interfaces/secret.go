...
type SecretProvider interface {
	// SaveSecret stores new secrets into the service's SecretStore at the specified secretName.
	SaveSecret(secretName string, secrets map[string]string) error

	// RetrieveSecret retrieves secrets from the service's SecretStore at the specified secretName.
