...
// NewMessageBusReporter creates a new MessageBus reporter which reports metrics to the IIOT MessageBus
func NewMessageBusReporter(lc logger.LoggerClient, baseTopic string, serviceName string, dic *di.Container, config *config.TelemetryInfo) interfaces.MetricsReporter {
...
// Report collects all the current metrics and reports them to the IIOT MessageBus
