...
import (
	...
	"iiot-backend/pkg/go-mod-bootstrap/bootstrap/messaging"
...
func (e *ExternalMQTT) BootstrapHandler(ctx context.Context, wg *sync.WaitGroup, startupTimer startup.Timer, dic *di.Container) bool {
	...
	// TODO: remove first check and update error log in IIOT 3.0
	...
	secretData, err := messaging.RetrieveSecretData(authMode, brokerConfig.SecretName, secretProvider)
	if err != nil {
