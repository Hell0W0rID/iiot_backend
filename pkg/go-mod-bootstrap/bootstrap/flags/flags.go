...
// Common is an interface that defines AP for the common command-line flags used by most IIOT services
...
// Default is the Default implementation of Common used by most IIOT services
type Default struct {
...
func (d *Default) helpCallback() {
	fmt.Printf(
		"Usage: %s [options]\n"+
			...
			"    -rsh, \n"+
			"     --remoteServiceHosts \n"+
			"          <host names>           Indicates that the service is running remote from the core IIOT services and\n"+
