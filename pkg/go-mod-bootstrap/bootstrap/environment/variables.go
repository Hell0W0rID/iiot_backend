...
const (
	...
	envKeyConfigUrl          = "IIOT_CONFIG_PROVIDER"
	envKeyCommonConfig       = "IIOT_COMMON_CONFIG"
	envKeyUseRegistry        = "IIOT_USE_REGISTRY"
	envKeyStartupDuration    = "IIOT_STARTUP_DURATION"
	envKeyStartupInterval    = "IIOT_STARTUP_INTERVAL"
	envKeyConfigDir          = "IIOT_CONFIG_DIR"
	envKeyProfile            = "IIOT_PROFILE"
	envKeyConfigFile         = "IIOT_CONFIG_FILE"
	envKeyFileURITimeout     = "IIOT_FILE_URI_TIMEOUT"
	envKeyRemoteServiceHosts = "IIOT_REMOTE_SERVICE_HOSTS"
	envKeyOverwriteConfig    = "IIOT_OVERWRITE_CONFIG"
...
func NewVariables(lc logger.LoggerClient) *Variables {
	osEnv := os.Environ()
	e := &Variables{
...
func GetConfigDir(lc logger.LoggerClient, configDir string) string {
...
// or uses passed in value or default if previous result in blank.
func GetProfileDir(lc logger.LoggerClient, profileDir string) string {
...
func GetConfigFileName(lc logger.LoggerClient, configFileName string) string {
...
// or uses passed in value.
func GetCommonConfigFileName(lc logger.LoggerClient, commonConfigFileName string) string {
...
func logEnvironmentOverride(lc logger.LoggerClient, name string, key string, value string) {
	valueStr := value
...
func GetURIRequestTimeout(lc logger.LoggerClient) time.Duration {
...
func GetRemoteServiceHosts(lc logger.LoggerClient, remoteHosts []string) []string {
...
func OverwriteConfig(lc logger.LoggerClient) (bool, bool) {
