...
func NewSecretsClient(ctx context.Context, config types.SecretConfig, lc logger.LoggerClient, callback pkg.TokenExpiredCallback) (*Client, error) {
...
// RetrieveSecret retrieves the secret at the provided secretName that matches the specified keys.
func (c *Client) RetrieveSecret(secretName string, keys ...string) (map[string]string, error) {
...
// SaveSecret stores the secret at the provided secret name for the specified keys.
func (c *Client) SaveSecret(secretName string, secrets map[string]string) error {
...
func (c *Client) RetrieveSecretNames() ([]string, error) {
