...
type runtimetokenprovider struct {
	...
	getTLSConfig         func(context.Context, logger.LoggerClient) (*tls.Config, error)
	source               *workloadapi.X509Source
}

// NewRuntimeTokenProvider creates a new runtime token provider
func NewRuntimeTokenProvider(ctx context.Context, lc logger.LoggerClient,
...
func (p *runtimetokenprovider) SetTLSConfigFunc(tlsConfFunc func(context.Context, logger.LoggerClient) (*tls.Config, error)) {
	p.getTLSConfig = tlsConfFunc
}

func (p *runtimetokenprovider) defaultGetTLSConfig(ctx context.Context, lc logger.LoggerClient) (*tls.Config, error) {
