...
// RetrieveSecret provides a mock function with given fields: secretName, keys
func (_m *SecretClient) RetrieveSecret(secretName string, keys ...string) (map[string]string, error) {
...
// RetrieveSecretNames provides a mock function with given fields:
func (_m *SecretClient) RetrieveSecretNames() ([]string, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for RetrieveSecretNames")
	}
...
// SaveSecret provides a mock function with given fields: secretName, data
func (_m *SecretClient) SaveSecret(secretName string, data map[string]string) error {
