...
func GetRequest(ctx context.Context, returnValuePointer interface{}, baseUrl string, requestPath string, requestParams url.Values, authInjector interfaces.AuthenticationInjector) errors.IIOT {
...
func GetRequestAndReturnBinaryRes(ctx context.Context, baseUrl string, requestPath string, requestParams url.Values, authInjector interfaces.AuthenticationInjector) (res []byte, contentType string, edgeXerr errors.IIOT) {
...
func GetRequestWithBodyRawData(ctx context.Context, returnValuePointer interface{}, baseUrl string, requestPath string, requestParams url.Values, data interface{}, authInjector interfaces.AuthenticationInjector) errors.IIOT {
...
func PostRequest(
	...
	data []byte,
	encoding string, authInjector interfaces.AuthenticationInjector) errors.IIOT {
...
func PostRequestWithRawData(
	...
	data interface{}, authInjector interfaces.AuthenticationInjector) errors.IIOT {
...
func PostRequestWithRawDataAndHeaders(
	...
	headers map[string]string) errors.IIOT {
...
func PostByFileRequest(
	...
	returnValuePointer interface{},
	baseUrl string, requestPath string,
	filePath string, authInjector interfaces.AuthenticationInjector) errors.IIOT {
...
func DeleteRequest(ctx context.Context, returnValuePointer interface{}, baseUrl string, requestPath string, authInjector interfaces.AuthenticationInjector) errors.IIOT {
...
func DeleteRequestWithParams(ctx context.Context, returnValuePointer interface{}, baseUrl string, requestPath string, requestParams url.Values, authInjector interfaces.AuthenticationInjector) errors.IIOT {
...
func processRequest(ctx context.Context,
	returnValuePointer any, req *http.Request, authInjector interfaces.AuthenticationInjector) errors.IIOT {
	...
	if err := json.Unmarshal(resp, returnValuePointer); err != nil {
		return errors.NewCommonIIOT(errors.KindContractInvalid, "failed to parse the response body", err)
	}
	return nil
}
