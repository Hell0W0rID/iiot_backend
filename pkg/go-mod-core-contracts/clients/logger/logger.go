...
/*
Package logger provides a client for integration with the iiot-logging service. The client can also be configured
to write logs to a local file rather than sending them to a service.
*/
package logger

// Logging client for the Go implementation of iiotfoundry
...
// LoggerClient defines the interface for logging operations.
...
// NewClient creates an instance of LoggerClient
func NewClient(owningServiceName string, logLevel string) LoggerClient {
