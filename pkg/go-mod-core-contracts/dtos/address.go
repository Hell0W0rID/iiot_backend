...
func (a *Address) Validate() error {
	...
	if err != nil {
		return errors.NewCommonIIOT(errors.KindContractInvalid, "invalid Address.", err)
	}
	switch a.Type {
	case common.REST:
		err = common.Validate(a.RESTAddress)
		if err != nil {
			return errors.NewCommonIIOT(errors.KindContractInvalid, "invalid RESTAddress.", err)
		}
	case common.MQTT:
		err = common.Validate(a.MQTTPubAddress)
		if err != nil {
			return errors.NewCommonIIOT(errors.KindContractInvalid, "invalid MQTTPubAddress.", err)
		}
	...
	case common.ZeroMQ:
		err = common.Validate(a.MessageBus)
		if err != nil {
			return errors.NewCommonIIOT(errors.KindContractInvalid, "invalid ZeroMQAddress.", err)
		}
	case common.EMAIL:
		err = common.Validate(a.EmailAddress)
		if err != nil {
			return errors.NewCommonIIOT(errors.KindContractInvalid, "invalid EmailAddress.", err)
		}
	}
...
type RESTAddress struct {
	...
	InjectIIOTAuth bool   `json:"injectIIOTAuth,omitempty"`
}
...
func ToAddressModel(a Address) models.Address {
	...
	case common.REST:
		address = models.RESTAddress{
			...
			InjectIIOTAuth: a.RESTAddress.InjectIIOTAuth,
		}
	case common.MQTT:
...
func FromAddressModelToDTO(address models.Address) Address {
	dto := Address{
		Type:   address.GetServiceAddress().Type,
		Scheme: address.GetServiceAddress().Scheme,
		Host:   address.GetServiceAddress().Host,
		Port:   address.GetServiceAddress().Port,
	}
	...
	case models.RESTAddress:
		dto.RESTAddress = RESTAddress{
			...
			InjectIIOTAuth: a.InjectIIOTAuth,
		}
