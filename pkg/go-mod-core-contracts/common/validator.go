...
const (
        dtoDurationTag                     = "iiot-dto-duration"
        dtoUuidTag                         = "iiot-dto-uuid"
        dtoNoneEmptyStringTag              = "iiot-dto-none-empty-string"
        dtoValueType                       = "iiot-dto-value-type"
        dtoRFC3986UnreservedCharTag        = "iiot-dto-rfc3986-unreserved-chars"
        emptyOrDtoRFC3986UnreservedCharTag = "len=0|" + dtoRFC3986UnreservedCharTag
        dtoInterDatetimeTag                = "iiot-dto-interval-datetime"
        dtoNoReservedCharTag               = "iiot-dto-no-reserved-chars"
        emptyOrDtoNoReservedCharTag        = "len=0|" + dtoNoReservedCharTag
        dtoUsernameTag                     = "iiot-dto-username"
        dtoPasswordTag                     = "iiot-dto-password" // nolint:gosec
)
...
func Validate(a interface{}) error {
        ...
        if err != nil {
                ...
                return errors.NewCommonIIOT(errors.KindContractInvalid, strings.Join(errMsg, "; "), nil)
        }
        return nil
}
...
// ex. iiot-dto-duration=10ms0x2C24h - 10ms represents the minimum Duration and 24h represents the maximum Duration
